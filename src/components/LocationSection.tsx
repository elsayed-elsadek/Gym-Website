...
const LocationSection: React.FC = () => {
  ...
  return (
    <section id="location" className="py-20 px-4 bg-gradient-to-br from-gray-900 to-gray-800 rounded-2xl shadow-2xl my-12 max-w-4xl mx-auto" data-aos="fade-up">
      <h2 className="text-4xl font-extrabold text-yellow-400 mb-8 text-center">موقعنا على الخريطة</h2>
      <div className="flex flex-col md:flex-row gap-8 items-center justify-center">
        {/* الفرع الأول */}
        <div className="flex-1 w-full max-w-md">
          <h3 className="text-2xl font-bold text-yellow-300 mb-2 text-center md:text-right">الفرع الأول</h3>
          <p className="text-gray-200 mb-4 text-center md:text-right">البر الشرقي شارع النويشي متفرع من سعد زغلول بجوار مسجد ابو بكر الصديق</p>
        ...
        {/* الفرع الثاني */}
        <div className="flex-1 w-full max-w-md">
          <h3 className="text-2xl font-bold text-yellow-300 mb-2 text-center md:text-right">الفرع الثاني</h3>
          <p className="text-gray-200 mb-4 text-center md:text-right"><br/>شارع باريس امام بيت المحافظ بجوار بنك عوده </p>
          <div className="w-full h-72 rounded-2xl overflow-hidden shadow-lg border-4 border-yellow-400 flex items-center justify-center bg-gray-700 mb-2">
            <iframe
              title="فرع باريس"
