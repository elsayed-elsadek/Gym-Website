...
const TrainersSection: React.FC = () => (
  ...
  data-aos="zoom-out">
    ...
    className="mb-8 flex flex-col gap-2 items-center">
      ...
      <p 
      className="text-lg text-yellow-200 font-bold text-center">
        معاك خطوة بخطوة لتحقيق هدفك الرياضي
        </p>

      <p
      className="text-base text-white font-medium text-center">
        مدربين معتمدين يشرحوا لك التمارين ويوجهوك صح في كل مرحلة
        </p>
  ...
  {/* قسم المدربين */}
    ...
    className="mt-16 max-w-3xl mx-auto">
      ...
      <div 
      className="bg-gray-800 rounded-2xl shadow-lg p-6 flex flex-col gap-4 text-end">

        <div>
          <h4 className="text-yellow-300 font-bold mb-1">
            هل يوجد مدربين للسيدات؟
            </h4>
        ...
        <div>
          <h4 className="text-yellow-300 font-bold mb-1">
            هل يمكن تجربة الجيم قبل الاشتراك؟
            </h4>
