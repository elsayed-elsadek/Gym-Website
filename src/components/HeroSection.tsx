  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 w-full max-w-2xl mx-auto px-4" data-aos="fade-down">
        <h1 className="text-4xl sm:text-5xl md:text-7xl font-extrabold text-yellow-400 drop-shadow-lg mb-6 leading-tight">PowerHouse Gym</h1>
        ...
        <a href="#contact" className="inline-block bg-yellow-400 text-gray-900 font-bold py-3 px-8 rounded-full text-lg shadow-lg hover:bg-yellow-300 transition duration-200 focus:outline-none focus:ring-4 focus:ring-yellow-300">سجّل الآن</a>
      </div>
    </header>
  );
};
